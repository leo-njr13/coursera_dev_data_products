...
shinyUI(pageWithSidebar(
    ...
    sidebarPanel(
        ...
        hr(),
        h3('Author: Rick Osborne'),
        p('Rick is a Web programmer by day, a runner by night, and an avid learner on weekends.  This app is the final project for the Data Science specialization offered by Coursera and the Johns Hopkins Bloomberg School of Public Health.'),
        p('The datasets here are from runs Rick did in Nov 2007.  The data and this app are copyright 2014 by Rick Osborne and all rights are reserved.')
    ),
    mainPanel(
        h3('Run Segments'),
        plotOutput('chart'),
